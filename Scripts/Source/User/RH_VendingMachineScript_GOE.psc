ScriptName RH_VendingMachineScript_GOE Extends RH_VendingMachineScript
...
Use this instead of RH_VendingMachineScript if you want the machine to respect
...
Preferred over RH_VendingMachineScript_F4SE: one native call, no struct type and
